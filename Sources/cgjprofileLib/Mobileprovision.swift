...
/// Holds a mobile provisioning profile
public class Mobileprovision {
    
    /// Error from the Cryptographic Message System
    enum CMSError : Error {
        case create
        case update
        case finalize
    ...
    /**
     Initializes a new Mobileprovision object from a Plist
     
     - Parameter plist: A Plist of the mobile provision file
     - Returns: Mobileprovision object
     */
    ...
    /**
     Initalizes a Mobileprovision object from a URL
     
     - Parameter url: A URL pointing to a .mobileprovision file
     - Returns: A Mobileprovision object or nil
     */
    ...
    /**
     Initalizes a Mobileprovision object from Data
     
     - Parameter data: Data containing the content of a .mobileprovision file
     - Returns: A Mobileprovision object or nil
     */
    ...
    public var daysToExpiration : Int {
            ...
            return Mobileprovision.daysTo(date: expDate)
    }
    
    /// Calculates the number of days to a certain date.
    /// - Parameter date: Target date
    /// - Returns: Number of days to target date. Negative if target date is in the past
    public static func daysTo(date : Date) -> Int {
        let cal = Calendar.current
        let components = cal.dateComponents([Calendar.Component.day], from: Date(), to: date)
        return components.day ?? 0

    }
    
    static func identityCertificates () throws -> [String : SecCertificate] {
    ...
    /// Decodes a Cryptographic Message
